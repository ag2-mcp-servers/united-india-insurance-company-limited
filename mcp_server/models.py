...
class CertificateParameters(BaseModel):
    ...
    UDF1: str = Field(
        ..., description='Policy Number', examples=['0317002620P100108515']
    )
    UDF2: str = Field(..., description='Policy Effective Date', examples=['DD-MM-YYYY'])
    UDF3: str = Field(..., description='Customer ID', examples=['1234234234'])
